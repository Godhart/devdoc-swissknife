...
```{r echo=FALSE, results='asis'}
  to_diagram("from_src", "Example - C4 Container Diagram", inline=FALSE, src="diagrams/Example-C4_Container_Diagram.Rmd")
```
...
cat("> *NOTE: mermaid is giving troubles in PDF (looks like transparency issues)*")
```
