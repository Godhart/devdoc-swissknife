...
Это проект демонстарции подхода к созданию документации на разработку с помощью R Markdown и
Kroki.
...
(Pandoc flavor) и дополнительными вставками кода на языке R, а так же текстовое описание разного рода диаграмм.
...
Уже один только R Markdown сам по себе является мощным и настраиваемым инструментом, который можно подстроить на формирование
...
В [этом разделе](#as_template) данный вопрос рассмотрен подробнее.
